...
import { mergeXssWhitelist } from './utils.js'
  ...
  async init () {
    ...
    this._schemasRegistered = this.onReady()
      .then(() => {
        ...
        this._library.xssWhitelist = mergeXssWhitelist({
          defaults: XSSDefaults,
          override: this.getConfig('xssWhitelistOverride'),
          additions: this.getConfig('xssWhitelist')
        })
      })
      .then(() => {
