...
import DataValidationError from './datavalidationerror.js';
 ...
 */
export default class JsonSchemaModule extends AbstractModule {
  /** @override */
  constructor(app, pkg) {
    super(app, pkg);
    ...
    // These are async functions, but we don't need to wait for them
    this.initFormats();
