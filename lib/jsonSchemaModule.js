...
class JsonSchemaModule extends AbstractModule {
  ...
  */
  async getSchema(schemaName) {
    ...
    return modelSchemas.reduce(async (m,s) => {
      this.applyPatch(m,s);
      const extensions = await this.loadSchemaExtensions(s.$id);
      extensions.forEach(e => this.applyPatch(m, e, { extendAnnotations: false }));
      return m;
    }, modelSchemas.shift());
  }
