...
class JsonSchema {
  ...
  static logBuildStat () {
    JsonSchema.buildCount = (JsonSchema.buildCount ?? 0) + 1
    JsonSchema.printBuildStat()
  }

  static printBuildStat () {
    console.log('JsonSchema build ran', JsonSchema.buildCount, 'times')
    JsonSchema.buildCount = 0
  }

  static logSanitiseStat () {
    JsonSchema.sanitiseCount = (JsonSchema.sanitiseCount ?? 0) + 1
    JsonSchema.printSanitiseStat()
  }

  static printSanitiseStat () {
    console.log('JsonSchema sanitise ran', JsonSchema.sanitiseCount, 'times')
    JsonSchema.sanitiseCount = 0
  }

  static logValidateStat () {
    JsonSchema.validateCount = (JsonSchema.validateCount ?? 0) + 1
    JsonSchema.printValidateStat()
  }

  static printValidateStat () {
    console.log('JsonSchema validate ran', JsonSchema.validateCount, 'times')
    JsonSchema.validateCount = 0
  }
}

JsonSchema.printBuildStat = _.debounce(JsonSchema.printBuildStat, 500)
JsonSchema.printSanitiseStat = _.debounce(JsonSchema.printSanitiseStat, 500)
JsonSchema.printValidateStat = _.debounce(JsonSchema.printValidateStat, 500)
